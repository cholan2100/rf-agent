...
def _generate_calibration_load_sch(spec: CircuitSpec, root_uuid: str, gen_date: str) -> str:
    """Generate KiCad 10 schematic for a dual 50-ohm RF calibration load standard."""
    u_j1, u_j2 = str(uuid.uuid4()), str(uuid.uuid4())
    u_r1, u_r2, u_r3, u_r4 = str(uuid.uuid4()), str(uuid.uuid4()), str(uuid.uuid4()), str(uuid.uuid4())
    u_gnd1, u_gnd2 = str(uuid.uuid4()), str(uuid.uuid4())

    r1_val = spec.components.get("R1", {}).get("value", "100R")
    r2_val = spec.components.get("R2", {}).get("value", "100R")
    r3_val = spec.components.get("R3", {}).get("value", "100R")
    r4_val = spec.components.get("R4", {}).get("value", "100R")
    j1_fp = spec.components.get("J1", {}).get("package", "Connector_Coaxial:SMA_Samtec_SMA-J-P-H-ST-EM1_EdgeMount")
    j2_fp = spec.components.get("J2", {}).get("package", "Connector_Coaxial:SMA_Samtec_SMA-J-P-H-ST-EM1_EdgeMount")
	...
	(title_block
		...
		(rev "1.0")
		(company "RF AI Suite")
		(comment 1 "Z0 = {spec.z0_ohm:.1f} Ohm | SOLT Calibration Match Standard")
		(comment 2 "Port 1: R1 || R2 = 50.0 Ohm | Port 2: R3 || R4 = 50.0 Ohm | Isolation > 60 dB")
	)
	(lib_symbols
{_get_common_lib_symbols()}
	)
	...
	(symbol (lib_id "Device:R") (at 55.88 101.6 0) (uuid "{u_r1}")
		(property "Reference" "R1" (at 50.8 101.6 0))
		(property "Value" "{r1_val}" (at 50.8 104.14 0))
		(property "Footprint" "Resistor_SMD:R_0805_2012Metric" (at 55.88 101.6 0) (effects (hide yes)))
	)
	(symbol (lib_id "Device:R") (at 71.12 101.6 0) (uuid "{u_r2}")
		(property "Reference" "R2" (at 76.2 101.6 0))
		(property "Value" "{r2_val}" (at 76.2 104.14 0))
		(property "Footprint" "Resistor_SMD:R_0805_2012Metric" (at 71.12 101.6 0) (effects (hide yes)))
	)
	(symbol (lib_id "power:GND") (at 63.5 119.38 0) (uuid "{u_gnd1}")
		(property "Reference" "#PWR01" (at 63.5 123.19 0) (effects (hide yes)))
		(property "Value" "GND" (at 63.5 124.46 0))
	)
	(wire (pts (xy 38.1 76.2) (xy 63.5 76.2)))
	(wire (pts (xy 63.5 76.2) (xy 55.88 76.2)))
	(wire (pts (xy 63.5 76.2) (xy 71.12 76.2)))
	(wire (pts (xy 55.88 76.2) (xy 55.88 97.79)))
	(wire (pts (xy 71.12 76.2) (xy 71.12 97.79)))
	(wire (pts (xy 55.88 105.41) (xy 55.88 114.3)))
	(wire (pts (xy 71.12 105.41) (xy 71.12 114.3)))
	(wire (pts (xy 55.88 114.3) (xy 71.12 114.3)))
	(wire (pts (xy 63.5 114.3) (xy 63.5 119.38)))
	(label "RF_IN" (at 45.72 73.66 0))

	(symbol (lib_id "Device:R") (at 106.68 101.6 0) (uuid "{u_r3}")
		(property "Reference" "R3" (at 101.6 101.6 0))
		(property "Value" "{r3_val}" (at 101.6 104.14 0))
		(property "Footprint" "Resistor_SMD:R_0805_2012Metric" (at 106.68 101.6 0) (effects (hide yes)))
	)
	(symbol (lib_id "Device:R") (at 121.92 101.6 0) (uuid "{u_r4}")
		(property "Reference" "R4" (at 127.0 101.6 0))
		(property "Value" "{r4_val}" (at 127.0 104.14 0))
		(property "Footprint" "Resistor_SMD:R_0805_2012Metric" (at 121.92 101.6 0) (effects (hide yes)))
	)
	(symbol (lib_id "Connector:Conn_Coaxial") (at 139.7 76.2 0) (uuid "{u_j2}")
		(property "Reference" "J2" (at 139.7 68.58 0))
		(property "Value" "SMA_OUT" (at 139.7 71.12 0))
	...
	(symbol (lib_id "power:GND") (at 114.3 119.38 0) (uuid "{u_gnd2}")
		(property "Reference" "#PWR02" (at 114.3 123.19 0) (effects (hide yes)))
		(property "Value" "GND" (at 114.3 124.46 0))
	)
	(wire (pts (xy 139.7 76.2) (xy 114.3 76.2)))
	(wire (pts (xy 114.3 76.2) (xy 106.68 76.2)))
	(wire (pts (xy 114.3 76.2) (xy 121.92 76.2)))
	(wire (pts (xy 106.68 76.2) (xy 106.68 97.79)))
	(wire (pts (xy 121.92 76.2) (xy 121.92 97.79)))
	(wire (pts (xy 106.68 105.41) (xy 106.68 114.3)))
	(wire (pts (xy 121.92 105.41) (xy 121.92 114.3)))
	(wire (pts (xy 106.68 114.3) (xy 121.92 114.3)))
	(wire (pts (xy 114.3 114.3) (xy 114.3 119.38)))
	(label "RF_OUT" (at 132.08 73.66 0))

	(text "50Ω Dual RF Calibration Load Standard (SOLT Match)\\nPort 1: R1 || R2 = 50.0Ω | Port 2: R3 || R4 = 50.0Ω\\nCenter Shield Isolation > 60 dB | Return Loss S11, S22 < -30 dB" (at 88.9 137.0 0) (effects (font (size 2.0 2.0))))
)
"""
